...
console.log('Element_of_array = quick_draw_data_set[random_no]');

sketchToDraw = Element_of_array;
...
function check_sketch() {
    var timer_counter = (timer_counter) + 1;
    <span id="Timer">"Time : " + timer_counter</span>;
